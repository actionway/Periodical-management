...
<br><br><br><br><br>
<h1><center>期刊征订表</center></h1>
<button onclick="location='soladd.jsp'" class="button button1">添加</button>
			<button onclick="location='soldelete.jsp'" class="button button1">删除</button>
			<br/>
			<br/>
			<form action="solselect.jsp" method="post" name="re">
