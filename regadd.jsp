...
<body>
<ul>
  <li><a class="active" onclick="location='regpage.jsp'">返回</a></li>

</ul>
<center>
<br/><br/><br/><br/><br/>
<form action="regaddac.jsp"method="post" name="re" >
			...
			<br/>			
			<input type="text" name="Index" id="Index" placeholder="请输入要加入的索引号">
			<br/>
			<input type="text" name="Borrow" id="Borrow" placeholder="请输入要加入的借阅数">
			<br/>
			<input type="text" name="Numelse" id="Numelse" placeholder="请输入要加入的剩余数量">
			<br/>
