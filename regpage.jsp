...
<button onclick="location='regadd.jsp'" class="button button1">添加</button>
			<button onclick="location='regdelete.jsp'" class="button button1">删除</button>
			<br/>
			<br/>
			<form action="regselect.jsp" method="post" name="re">
